         ...
         <!-- <div class="subTitle">
          ...
          <el-form ref="createSensorform" :model="createSensorform"  :rules="rules"  label-width="80px">
            ...
            <el-form-item label="设备名称" prop="sensorname">
              <div class="el-input">
                <input type="text" @input="sensorNameInputed" v-model="createSensorform.sensorname" class="el-input__inner" placeholder="请输入设备名称" />
              </div>
            </el-form-item>
            ...
            <el-form-item label="生产厂家" style="position:relative;" prop="cmonitorsType" >
              <el-select v-model="createSensorform.monitorsType" style="width:calc(100%);float: left;margin-right: 20px;" placeholder="请选择" @change="monitorsTypeSelect" >
                <el-option
              ...
              <el-input v-model="createSensorform.monitorsType" placeholder="请输入生产厂家" style="width:calc(100% - 40px);position:absolute;left:0px;" @blur="brandOrModelByInput" ></el-input>
            </el-form-item>


            <el-form-item label="设备型号"  style="position:relative;" prop="deviceModel" class="changeSelect">
              <el-select v-model="createSensorform.deviceModel"  style="width:calc(100%);float:left;margin-right: 20px;" placeholder="请选择" @change="sensorModelChanged">
                <el-option
              ...
              <el-input v-model="createSensorform.deviceModel" placeholder="请输入设备型号" ref="deviceModel" style="width:calc(100% - 40px);position:absolute;left:0px;" @blur="brandOrModelByInput"></el-input>
            ...
            <el-form-item label="安装位置">
              <el-input v-model="createSensorform.position" placeholder="请输入安装位置"></el-input>
            </el-form-item>
            ...
            <el-form :model="sensorExtend" ref="sensorExtend" label-width="80px">
              <div class="sub-wrap" v-for="(item,index) in sensorExtend.sensorExtend_dataList" :key="index" >
                ...
                <div class="el-form">
                  ...
                  >
                    <el-input v-model.number="item.serialnumber"  placeholder="请输入序号" disabled onkeyup="value=value.replace(/^(0+)|[^\d]+/g,'')"></el-input>
                  </el-form-item>
                  ...
                  <el-form-item label="监测参数"
                                ...
                                class="ivuSelect"
                  >
                    <Select  v-model="item.monitorInfo" placeholder="请选择"  size="large">
                      <OptionGroup
                  ...
                  >
                    <el-input v-model="item.accuracy" placeholder="请输入精度" style="float:left;width:100%;" onkeyup="value=value.replace(/^(0+)|[^\d]+/g,'')"></el-input>
                    <label >小数点后几位</label>
